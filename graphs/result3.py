...
class GraphNode(Node):
    def __init__(self):
        ...
        self.graph_sub = self.create_subscription(Float32MultiArray, 'bot_3/result', self.data_callback, 10)
        self.ep = []
        self.data = []
        self.rewards = []
        self.count = 1
...
class Window(QMainWindow):
    def __init__(self,node):
        ...
        self.node = node
        self.setWindowTitle("Result for BOT 3")
