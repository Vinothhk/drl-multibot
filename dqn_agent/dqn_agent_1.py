...
class DQNAgentOne(Node):
    def __init__(self):
        super().__init__('dqn_agent_1')
        ...
        ************************************************************"""
        ...
        self.model_path = os.path.join(self.model_dir_path,'model_one'+'_episode'+str(self.load_episode)+'.h5')
        ...
        for episode in range(self.load_episode+1, self.episode_size):
            ...
            if episode % 10 == 0:
                self.model_path = os.path.join(
                    self.model_dir_path,
                    'model_one'+'_episode'+str(episode)+'.h5')
...
def main(args=None):
    ...
    dqn_agent_1 = DQNAgentOne()
    rclpy.spin(dqn_agent_1)
