...
class DQNEnvironmentOne(Node):
    def __init__(self):
        ...
        ************************************************************"""
        ...
        self.goal_pose_sub = self.create_subscription(Pose,'bot_1/goal_pose',self.goal_pose_callback,10)
    ...
    *******************************************************************************"""
    ...
    def goal_pose_callback(self, msg):
        self.goal_pose_x = float(msg.position.x)
        self.goal_pose_y = float(msg.position.y)
